...
strategy=tf.contrib.tpu.TPUDistributionStrategy(
    tf.contrib.cluster_resolver.TPUClusterResolver('tpu-demo-vm')))
...
for i in range(epochs):
    ...
    # fit for one epoch
    tpu_model.fit_generator(generator, epochs=1, steps_per_epoch=steps, verbose=1)
    print('33333333333333')
    # save model
    tpu_model.save('model_' + str(i) + '.h5')
